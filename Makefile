...
# my.domain/foo-bundle:$VERSION and my.domain/foo-catalog:$VERSION.
IMAGE_TAG_BASE ?= quay.io/$(USER)/osp-director-operator
...
DEFAULT_IMG ?= quay.io/openstack-k8s-operators/osp-director-operator:latest
IMG ?= $(DEFAULT_IMG)
