...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OpenStackBaremetalHostProvisioningStatus) DeepCopyInto(out *OpenStackBaremetalHostProvisioningStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OpenStackBaremetalHostProvisioningStatus.
func (in *OpenStackBaremetalHostProvisioningStatus) DeepCopy() *OpenStackBaremetalHostProvisioningStatus {
	if in == nil {
		return nil
	}
	out := new(OpenStackBaremetalHostProvisioningStatus)
	in.DeepCopyInto(out)
	return out
}
