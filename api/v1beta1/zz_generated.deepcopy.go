...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OpenStackConfigGeneratorAdvancedSettings) DeepCopyInto(out *OpenStackConfigGeneratorAdvancedSettings) {
	*out = *in
	if in.SkipWaiting != nil {
		in, out := &in.SkipWaiting, &out.SkipWaiting
		*out = new(bool)
		**out = **in
	}
	if in.TripleoDeployConfigOverride != nil {
		in, out := &in.TripleoDeployConfigOverride, &out.TripleoDeployConfigOverride
		*out = new(string)
		**out = **in
	}
}
...
func (in *OpenStackConfigGeneratorAdvancedSettings) DeepCopy() *OpenStackConfigGeneratorAdvancedSettings {
	if in == nil {
		return nil
	}
	out := new(OpenStackConfigGeneratorAdvancedSettings)
	in.DeepCopyInto(out)
	return out
}
...
func (in *OpenStackConfigGeneratorSpec) DeepCopyInto(out *OpenStackConfigGeneratorSpec) {
	*out = *in
	...
	if in.TripleoRoleOverride != nil {
		in, out := &in.TripleoRoleOverride, &out.TripleoRoleOverride
		*out = make(map[string]TripleoRoleOverrideSpec, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
...
func (in *OpenStackEphemeralHeatSpec) DeepCopyInto(out *OpenStackEphemeralHeatSpec) {
	*out = *in
	out.HeatOverride = in.HeatOverride
}
...
func (in *TripleoRoleOverrideSpec) DeepCopyInto(out *TripleoRoleOverrideSpec) {
	*out = *in
	if in.HostIndexMap != nil {
		in, out := &in.HostIndexMap, &out.HostIndexMap
...
func (in *TripleoRoleOverrideSpec) DeepCopy() *TripleoRoleOverrideSpec {
	if in == nil {
		return nil
	}
	out := new(TripleoRoleOverrideSpec)
	in.DeepCopyInto(out)
	return out
}
