...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OvercloudHostIPStatus) DeepCopyInto(out *OvercloudHostIPStatus) {
	*out = *in
	if in.HostIPs != nil {
		in, out := &in.HostIPs, &out.HostIPs
		*out = make(map[string]OvercloudIPSetStatus, len(*in))
		for key, val := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OvercloudHostIPStatus.
func (in *OvercloudHostIPStatus) DeepCopy() *OvercloudHostIPStatus {
	if in == nil {
		return nil
	}
	out := new(OvercloudHostIPStatus)
	in.DeepCopyInto(out)
	return out
}
