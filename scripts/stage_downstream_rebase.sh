...
RUN sed -e "s|registry.redhat.io/rhosp-rhel8-tech-preview/|registry-proxy.engineering.redhat.com/rh-osbs/rhosp-rhel8-tech-preview-|" -i /osp-director-operator.clusterserviceversion.yaml
