...
func main() {
	...
	flag.StringVar(&conf.Host, "host", "osp-director-operator-admission-controller-service", "The hostname for the service")
	flag.Parse()
	...
	msg := "OSP Director Operator Admission Controller"
